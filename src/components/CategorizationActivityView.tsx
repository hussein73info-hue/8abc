        ...
        <div className="bg-white border-2 border-emerald-600/30 rounded-2xl p-6 sm:p-8 text-center space-y-4 shadow-sm animate-in fade-in">
          ...
          <div className="pt-4 border-t border-[#1B3A3D]/10 max-w-sm mx-auto space-y-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-xs font-bold text-[#1B3A3D] hover:text-[#C9A96E] underline py-1 transition-colors cursor-pointer"
            >
            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              {assignedKeys.length > 0 && (
                <button
                  ...
                  className="text-xs text-[#1B3A3D]/60 hover:text-red-600 flex items-center gap-1 transition-colors cursor-pointer"
                >
                ...
                {unassignedItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Mobile quick action buttons on card */}
                      <div className="flex items-center gap-1.5 pt-1 border-t border-[#1B3A3D]/10">
                        <button
                          ...
                          className="flex-1 py-1.5 px-2 bg-[#1B3A3D]/10 hover:bg-[#1B3A3D] hover:text-white text-[#1B3A3D] rounded-lg text-[11px] font-bold transition-colors flex items-center justify-center gap-1 cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 py-1.5 px-2 bg-[#C9A96E]/20 hover:bg-[#C9A96E] hover:text-[#1B3A3D] text-[#1B3A3D] rounded-lg text-[11px] font-bold transition-colors flex items-center justify-center gap-1 cursor-pointer"
                        >
            ...
            <button
              ...
              className={`w-full py-4 rounded-2xl font-bold text-base flex items-center justify-center gap-3 shadow-md transition-all ${
                unassignedItems.length > 0
                  ...
                  : 'bg-[#1B3A3D] hover:bg-[#264e52] text-[#F6F1E7] active:scale-[0.99] cursor-pointer'
              }`}
            >
          ...
          <div className="bg-[#FAF7F0] border-2 border-[#1B3A3D]/20 rounded-2xl w-full max-w-sm p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[#1B3A3D]/60 hover:text-[#1B3A3D] p-1 cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleUnlockSubmit} className="space-y-3">
              ...
              <div className="flex items-center justify-end gap-2 pt-1">
                <button
                  type="button"
                  onClick={() => setShowUnlockModal(false)}
                  className="px-3 py-2 text-xs font-medium text-[#1B3A3D]/70 cursor-pointer"
                >
                  إلغاء
                </button>
                <button
                  type="submit"
                  className="px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl text-xs font-bold transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                  <Unlock className="w-3.5 h-3.5" />
                  السماح بالإعادة
                </button>

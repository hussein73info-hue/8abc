      ...
      <header className="flex items-center justify-between px-3 sm:px-5 py-3.5 border-b border-[#D9CFB4] bg-[#F6F1E7] sticky top-0 z-20">
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            onClick={onLogout}
            id="indexLogoutBtn"
            className="inline-flex items-center gap-1.5 text-xs sm:text-sm text-[#5C7376] hover:text-[#A8432E] hover:underline font-semibold transition-colors cursor-pointer"
          >

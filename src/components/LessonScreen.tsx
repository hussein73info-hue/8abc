    ...
    <div className="w-full max-w-[820px] mx-auto min-h-screen pb-16">
      ...
      <header className="flex items-center justify-between px-3 sm:px-5 py-3 border-b border-[#D9CFB4] bg-[#F6F1E7] sticky top-0 z-20">
        <button
          ...
          id="backToIndexBtn"
          className="inline-flex items-center gap-1 text-xs sm:text-sm font-bold text-[#1B3A3D] hover:text-[#1E6FA6] transition-colors py-1 px-2.5 rounded-lg hover:bg-white/60 cursor-pointer"
        >
        ...
        <div className="text-center px-2 flex-1 max-w-[280px] sm:max-w-md">
          ...
          <div className="flex items-center justify-center gap-1.5">
            ...
            <button
              ...
              className="p-1 text-[#1B3A3D]/40 hover:text-[#1B3A3D] rounded-md transition-colors cursor-pointer"
              title="تعديل عنوان الدرس (محمي بكلمة مرور)"
            >
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <div className="flex items-center bg-white/70 rounded-lg p-0.5 border border-[#D9CFB4]">
            <button
              ...
              title="الدرس السابق"
              className="p-1 rounded-md text-[#1B3A3D] hover:bg-white disabled:opacity-30 disabled:pointer-events-none transition-colors cursor-pointer"
            >
      ...
      <main className="p-3 sm:p-5 md:p-6 space-y-6">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="p-1.5 text-[#1E6FA6]/60 hover:text-[#1E6FA6] hover:bg-white/60 rounded-lg transition-colors flex items-center gap-1 text-xs font-semibold cursor-pointer"
        ...
        >
          <div className="flex items-center justify-between mb-4 pb-2 border-b border-[#D9CFB4]/60">
            ...
            <button
              ...
              className="p-1.5 text-[#1B3A3D]/70 hover:text-[#1B3A3D] hover:bg-[#FAF7F0] rounded-lg transition-colors flex items-center gap-1 text-xs font-semibold cursor-pointer"
        ...
        <footer className="pt-4 flex items-center justify-between border-t border-[#D9CFB4]/80">
          {lessonIndex > 0 ? (
            <button
              onClick={() => onNavigateLesson(lessonIndex - 1)}
              className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-[#1B3A3D] bg-white border border-[#D9CFB4] px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl hover:bg-[#FAF7F2] transition-colors cursor-pointer"
            >
          ...
          <button
            onClick={onBackToIndex}
            className="text-xs sm:text-sm font-bold text-[#5C7376] hover:text-[#1B3A3D] underline px-2 py-1.5 cursor-pointer"
          >
            العودة للفهرس
          </button>
          ...
          {lessonIndex < totalLessons - 1 ? (
            <button
              onClick={() => onNavigateLesson(lessonIndex + 1)}
              className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-white bg-[#1B3A3D] px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl hover:bg-[#152e30] transition-colors cursor-pointer"
            >
            ...
            <button
              onClick={onBackToIndex}
              className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-white bg-emerald-700 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl hover:bg-emerald-800 transition-colors cursor-pointer"
            >

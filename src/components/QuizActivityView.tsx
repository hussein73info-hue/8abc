...
export const QuizActivityView: React.FC<QuizActivityViewProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    // Calculate score (kept hidden from student in UI)
    let score = 0;
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  {onEditQuestion && (
                    <button
                      ...
                      className="p-1.5 text-[#1B3A3D]/50 hover:text-[#1B3A3D] rounded-lg hover:bg-[#FAF7F0] transition-colors cursor-pointer"
                  ...
                  {q.options.map((opt, optIdx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-right p-3 rounded-xl border text-xs sm:text-sm font-medium transition-all flex items-center justify-between gap-3 cursor-pointer ${
                          isSelected

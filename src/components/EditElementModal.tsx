      ...
      <div className="bg-[#FAF7F0] border-2 border-[#1B3A3D]/20 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-[#1B3A3D] text-[#F6F1E7] px-5 py-4 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-[#F6F1E7]/70 hover:text-white transition-colors p-1 rounded-lg cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-sm font-medium text-[#1B3A3D]/70 hover:text-[#1B3A3D] transition-colors cursor-pointer"
            >
              إلغاء
            </button>
            <button
              type="submit"
              className="flex items-center gap-2 bg-[#1B3A3D] text-white px-5 py-2.5 rounded-xl font-medium text-sm hover:bg-[#264e52] transition-colors shadow-sm cursor-pointer"
            >

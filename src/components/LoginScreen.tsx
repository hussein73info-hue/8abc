        ...
        <div className="bg-white border-[1.5px] border-[#D9CFB4] rounded-2xl p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              id="doLoginBtn"
              className="w-full bg-[#1B3A3D] hover:bg-[#152e30] active:scale-[0.98] transition-transform text-white font-bold py-3.5 px-5 rounded-xl text-base shadow-sm mt-2 cursor-pointer"
            >
              دخول
            </button>
          </form>

      ...
      <div className="bg-[#FAF7F0] border-2 border-[#1B3A3D]/20 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 text-[#1B3A3D]">
        ...
        <div className="bg-[#1B3A3D] text-[#F6F1E7] px-5 py-4 flex items-center justify-between shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-[#F6F1E7]/70 hover:text-white transition-colors p-1.5 rounded-lg cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {!isAdminUnlocked ? (
          ...
          <form onSubmit={handleLogin} className="p-6 sm:p-8 space-y-6">
            ...
            <div className="max-w-xs mx-auto space-y-3">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#1B3A3D] text-[#F6F1E7] rounded-xl font-bold hover:bg-[#264e52] transition-colors shadow-md cursor-pointer"
              >
                دخول لوحة المسؤول
              </button>
            </div>
          ...
          <div className="flex flex-col flex-1 overflow-hidden">
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
                    ...
                    {submissions.length > 0 && (
                      <button
                        ...
                        className="text-xs text-red-600 hover:text-red-700 underline px-2 py-1 cursor-pointer"
                      >
                        مسح السجل
                      </button>
                    )}
                          ...
                          <div className="flex items-start justify-between gap-2 flex-wrap">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="text-xs bg-[#1B3A3D]/10 hover:bg-[#1B3A3D]/20 text-[#1B3A3D] px-2.5 py-1 rounded-lg font-medium transition-colors flex items-center gap-1 cursor-pointer"
              ...
              {activeTab === 'unlock' && (
                <div className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl font-bold text-sm shadow-md transition-colors flex items-center justify-center gap-2 cursor-pointer"
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white border border-red-200 rounded-xl p-4 sm:p-5 space-y-3">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-red-50 hover:bg-red-100 text-red-700 border border-red-300 rounded-lg text-xs font-bold transition-colors cursor-pointer"
                    >
            ...
            <div className="bg-[#FAF7F0] border-t border-[#1B3A3D]/15 px-5 py-3 flex items-center justify-between text-xs text-[#1B3A3D]/70 shrink-0">
              ...
              <button
                type="button"
                onClick={onClose}
                className="px-3 py-1.5 bg-[#1B3A3D] text-white rounded-lg font-medium hover:bg-[#264e52] transition-colors cursor-pointer"
              >
                إغلاق
              </button>
            </div>

...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F1E7] text-[#1B3A3D] flex flex-col font-['Tajawal',sans-serif] relative" dir="rtl">
      {/* Global Quick Admin Trigger for Login / Welcome Screen */}
      {(screen === 'login' || screen === 'welcome') && (
        <button
          type="button"
          onClick={() => setShowAdminModal(true)}
          className="fixed bottom-4 left-4 z-40 bg-[#1B3A3D] text-white hover:bg-[#254F53] px-3.5 py-2 rounded-full text-xs font-bold shadow-lg flex items-center gap-2 border border-[#C9A96E]/40 transition-all hover:scale-105 active:scale-95 cursor-pointer"
